...
function Footer() {
  return (
   <>
      <div className='bg-primary d-flex flex-row align-items-center justify-content-between p-3'>
        <div className="bwc__sc-au4qa5-46 fDqlDq d-flex align-items-center mx-5 ">
        <img alt="hut" src="//in.bmscdn.com/webin/common/icons/hut.svg" class="bwc__sc-au4qa5-50 gipVVh"/>
        <span className='fs-4 list text-light'>List Your Show</span>
          <h5 className='text-light mx-5 '> Got a show, event, activity or a great experience? Partner with us &amp; get listed on BookMyShow</h5>
        </div>
        <div>
      ...
      <div style={{cursor:"pointer"}} className="">
        ...
        <div style={{width:"250px",padding:'10px',marginLeft:"-55px"}} className="ml-2">SUSCRIBE TO THE NEWSLETTER</div>
        </div>
      </div>
        
      </div>

      <div style={{paddingLeft: "200px", paddingTop: "15px"}} className='foot bg-primary text-secondary d-flex flex-wrap flex-column justify-content-center'>
      <div style={{width: "80%"}}>
        <span className='text'>MOVIES NOW SHOWING</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Kannur Squad | Iraivan | Chandramukhi 2 | The Creator | Fukrey 3 | Theeppori Benny | Skanda | RDX | Jawan | Nadhikalil Sundari Yamuna</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>UPCOMING MOVIES</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Chaaver | Dono | Raththam | Mission Raniganj: The Great Bharat Rescue | Dumb Money | Marakastra | Any How Mitti Pao | Raakshasa Kaavyam | Aade Nam God | Raja Marthanda | Mad (2023) | Fighter (Kannada) | Irugapatru | Aatmapamphlet | Month of Madhu | Nossir Kouto | Thank You For Coming | Rules Ranjann | Tahi Mor Sona | Love (Kannada)</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>MOVIES BY GENRE</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Drama Movies | Thriller Movies | Crime Movies | Action Movies | Horror Movies | Comedy Movies | Mystery Movies | Sci-Fi Movies | Adaptation Movies | Mythological Movies | Noir Movies | Political Movies | Supernatural Movies | Sports Movies | Heist Movies | Historical Movies | Tragedy Movies | Animation Movies | Anime Movies | Psychological Movies | War Movies | Period Movies | Classic Movies | Adventure Movies | Musical Movies | Adult Movies | Screening Movies | Fantasy Movies | Suspense Movies | Biography Movies | Romantic Movies | Bollywood Movies | Devotional Movies</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>MOVIES BY LANGUAGE</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Movies in Malayalam | Movies in English | Movies in Tamil | Movies in Hindi | Movies in Chattisgarhi | Movies in Khasi | Movies in English 7D | Movies in Nepali | Movies in French | Movies in Tulu | Movies in Japanese | Movies in Assamese | Movies in Odia Movies in Portuguese | Movies in Rajasthani | Movies in Konkani | Movies in Sindhi | Movies in Punjabi | Movies in Bhojpuri | Movies in Marathi | Movies in Haryanavi | Movies in Bengali | Movies in Urdu | Movies in Telugu | Movies in Kannada | Movies in Gujarati</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>PLAYS BY GENRE</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Adaptation Plays | Mythological Plays | Noir Plays | Online Streaming Plays Plays | Political Plays | Historical Plays | Tragedy Plays | Horror Plays | Psychological Plays | Mystery Plays | War Plays | Period Plays | Classic Plays | Adventure Plays | Musical Plays | Adult Plays | Fantasy Plays | Thriller Plays | Action Plays | Drama Plays | Sci-Fi Plays | Comedy Plays | Suspense Plays | Biography Plays | Broadway Plays | Romantic Plays | Contemporary Plays | Regional Plays | Tribute Plays</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>MOVIE REVIEWS AND TRENDING ARTICLES</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Trending Articles | Latest News on Movies, Events, Plays and Sports | Movie Celebrities</p>
      </div>
      <div style={{width:"80%"}}>
        <span className='text'>MOVIE UPDATES AND CELEBRITIES</span>
        <p style={{marginTop: '10px', cursor: 'pointer'}}>Upcoming Movies Movies Now Showing | Movie Celebrities</p>
      </div>
    </div>

        <div className="line-container p-4 bg-primary">
         <div class="line"></div>
         <div className="text fs-3">BookMyShow</div>
         <div class="line"></div>
        </div>



    <div className='icons bg-primary p-5 d-flex justify-content-center'>
  <a href='https://www.facebook.com/yourfacebookpage' target='_blank' rel='noopener noreferrer'>
    <i className='ic fab fa-facebook fa-2x rounded-circle mx-2'></i>
  </a>
  <a href='https://twitter.com/yourtwitterhandle' target='_blank' rel='noopener noreferrer'>
    <i className='ic fab fa-twitter-square fa-2x rounded-circle mx-2'></i>
  </a>
  <a href='https://www.instagram.com/yourinstagramhandle' target='_blank' rel='noopener noreferrer'>
    <i className='ic fab fa-instagram fa-2x rounded-circle mx-2'></i>
  </a>
  <a href='https://www.youtube.com/yourchannel' target='_blank' rel='noopener noreferrer'>
    <i className='ic fab fa-youtube fa-2x rounded-circle mx-2'></i>
  </a>
  <a href='https://www.linkedin.com/in/yourprofile' target='_blank' rel='noopener noreferrer'>
    <i className='ic fab fa-linkedin fa-2x rounded-circle mx-2'></i>
  </a>
</div>
      <div className='ftext text-secondary bg-primary p-3 '>
     <p className='ft'>
